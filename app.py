...
#idx: target item's index
    ...
    return trails[['name','state_name', 'area_name']].iloc[df_sim['tfidf_index']]

if st.button('Show Hikes'):
    hike_name, hike_state, area = get_similar(selected_trail, n=5)['name'].tolist(), get_similar(selected_trail, n=5)['state_name'].tolist(), get_similar(selected_trail, n=5)['area_name'].tolist()
