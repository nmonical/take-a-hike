...
if st.button('Show Hikes'):
    hike_name, hike_state, slug, area = get_similar(selected_trail, n=5)['name'].tolist(), get_similar(selected_trail, n=5)['state_name'].tolist(), get_similar(selected_trail, n=5)['slug'].tolist(), get_similar(selected_trail, n=5)['area_name'].tolist()
